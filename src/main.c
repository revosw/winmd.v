	...
	#define V_COMMIT_HASH "f9e8a91"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "89aa695"
#endif
...
typedef struct main__IUnknown main__IUnknown;
...
typedef struct main__Guid main__Guid;
typedef struct main__MetadataDispenser main__MetadataDispenser;
...
// added by module `main`, file: main.v:6:

#if defined(__has_include)

#if __has_include(<roapi.h>)
#include <roapi.h>
#else
#error VERROR_MESSAGE Header file <roapi.h>, needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
// added by module `main`, file: main.v:7:

#if defined(__has_include)

#if __has_include(<RoMetadataApi.h>)
#include <RoMetadataApi.h>
#else
#error VERROR_MESSAGE Header file <RoMetadataApi.h>, needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
// added by module `main`, file: main.v:8:

#if defined(__has_include)

#if __has_include(<rometadata.h>)
#include <rometadata.h>
#else
#error VERROR_MESSAGE Header file <rometadata.h>, needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
typedef int main__RoInitType;
	#define main__RoInitType__singlethreaded (0)
	#define main__RoInitType__multithreaded (0+1)
...
typedef int* winmd__HCorEnum;
typedef u8* winmd__PcCor_Signature;
typedef u8* winmd__PCor_Signature;
typedef u8* winmd__Uvcp_Constant;
typedef u8* winmd__MdUtf8Cstr;
typedef u32 winmd__MdToken;
typedef u32 winmd__MdModule;
typedef u32 winmd__MdTypeRef;
typedef u32 winmd__MdTypeDef;
typedef u32 winmd__MdFieldDef;
typedef u32 winmd__MdMethodDef;
typedef u32 winmd__MdParamDef;
typedef u32 winmd__MdInterfaceImpl;
typedef u32 winmd__MdMemberRef;
typedef u32 winmd__MdCustomAttribute;
typedef u32 winmd__MdPermission;
typedef u32 winmd__MdSignature;
typedef u32 winmd__MdEvent;
typedef u32 winmd__MdProperty;
typedef u32 winmd__MdModuleRef;
typedef u32 winmd__MdAssembly;
typedef u32 winmd__MdAssemblyRef;
typedef u32 winmd__MdFile;
typedef u32 winmd__MdExportedType;
typedef u32 winmd__MdManifestResource;
typedef u32 winmd__MdTypeSpec;
typedef u32 winmd__MdGenericParam;
typedef u32 winmd__MdMethodSpec;
typedef u32 winmd__MdGenericParamConstraint;
typedef u32 winmd__MdString;
...
struct main__IUnknown {
	union {
		void* _object;
	};
	int _typ;
	anon_fn_* query_interface;
	anon_fn_* add_ref;
	anon_fn_* release;
};
...
struct main__MetadataDispenser {
	main__Guid clsid;
	main__Guid iid;
	voidptr* ppv;
};
...
static char * v_typeof_interface_main__IUnknown(int sidx);
...
array __new_array_with_array_default_noscan(int mylen, int cap, int elm_size, array val, int depth);
void vhalt(void);
...
VV_LOCAL_SYMBOL  int compare_7566286269888172044_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
main__MetadataDispenser main__get_metadata_dispenser(void);
...
// ^^^ number of types for interface main__IUnknown: 0
...
static char * v_typeof_interface_main__IUnknown(int sidx) { /* main.IUnknown */ 
	return "unknown IUnknown";
}

static int v_typeof_interface_idx_main__IUnknown(int sidx) { /* main.IUnknown */ 
	return 107;
}
...
multi_return_u32_u32 math__bits__div_32(u32 hi, u32 lo, u32 y) {
	if (y != 0U && y <= hi) {
		panic_debug(410, tos3("C:/dev/_tools/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_32"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
...
multi_return_u64_u64 math__bits__div_64(u64 hi, u64 lo, u64 y1) {
	u64 y = y1;
	if (y == 0U) {
		panic_debug(425, tos3("C:/dev/_tools/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_64"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
	if (y <= hi) {
		panic_debug(428, tos3("C:/dev/_tools/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_64"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
...
string strconv__format_int(i64 n, int radix) {
	{ // Unsafe block
		if (radix < 2 || radix > 36) {
			panic_debug(11, tos3("C:/dev/_tools/v/vlib/strconv/number_to_base.c.v"), tos3("strconv"), tos3("format_int"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("invalid radix: "), /*100 &int*/0xfe07, {.d_i32 = radix}}, {_SLIT(" . It should be => 2 and <= 36"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (n == 0) {
			return _SLIT("0");
...
string strconv__format_uint(u64 n, int radix) {
	{ // Unsafe block
		if (radix < 2 || radix > 36) {
			panic_debug(48, tos3("C:/dev/_tools/v/vlib/strconv/number_to_base.c.v"), tos3("strconv"), tos3("format_uint"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("invalid radix: "), /*100 &int*/0xfe07, {.d_i32 = radix}}, {_SLIT(" . It should be => 2 and <= 36"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (n == 0U) {
			return _SLIT("0");
...
string strconv__v_sprintf(string str, Array_voidptr pt) {
	...
	if (p_index != pt.len) {
		panic_debug(541, tos3("C:/dev/_tools/v/vlib/strconv/vprintf.c.v"), tos3("strconv"), tos3("v_sprintf"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT0, /*100 &int*/0xfe07, {.d_i32 = p_index}}, {_SLIT(" % conversion specifiers, but given "), /*100 &int*/0xfe07, {.d_i32 = pt.len}}, {_SLIT(" args"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
...
inline void strconv__v_sprintf_panic(int idx, int len) {
	if (idx >= len) {
		panic_debug(550, tos3("C:/dev/_tools/v/vlib/strconv/vprintf.c.v"), tos3("strconv"), tos3("v_sprintf_panic"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT0, /*100 &int*/0xfe07, {.d_i32 = idx + 1}}, {_SLIT(" % conversion specifiers, but given only "), /*100 &int*/0xfe07, {.d_i32 = len}}, {_SLIT(" args"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
}
...
void array_ensure_cap(array* a, int required) {
	...
	if (ArrayFlags_has(&a->flags, ArrayFlags__nogrow)) {
		panic_debug(156, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("ensure_cap"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("array.ensure_cap: array with the flag `.nogrow` cannot grow in size, array required new size: "), /*100 &int*/0xfe07, {.d_i32 = required}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
...
array array_repeat_to_depth(array a, int count, int depth) {
	if (count < 0) {
		panic_debug(194, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("repeat_to_depth"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("array.repeat: count is negative: "), /*100 &int*/0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
...
void array_insert(array* a, int i, voidptr val) {
	...
	{
		if (i < 0 || i > a->len) {
			panic_debug(248, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("insert"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.insert: index out of range (i == "), /*100 &int*/0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), /*100 &int*/0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_insert_many(array* a, int i, voidptr val, int size) {
	...
	{
		if (i < 0 || i > a->len) {
			panic_debug(267, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("insert_many"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.insert_many: index out of range (i == "), /*100 &int*/0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), /*100 &int*/0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_delete_many(array* a, int i, int size) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (i < 0 || i + size > a->len) {
			...
			panic_debug(327, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("delete_many"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("array.delete: index out of range (i == "), /*100 &int*/0xfe07, {.d_i32 = i}}, {_SLIT0, /*115 &string*/0xfe10, {.d_s = endidx}}, {_SLIT(", a.len == "), /*100 &int*/0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_get(array a, int i) {
	...
	{
		if (i < 0 || i >= a.len) {
			panic_debug(408, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("get"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.get: index out of range (i == "), /*100 &int*/0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), /*100 &int*/0xfe07, {.d_i32 = a.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_first(array a) {
	...
	{
		if (a.len == 0) {
			panic_debug(433, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("first"),  _SLIT("array.first: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_last(array a) {
	...
	{
		if (a.len == 0) {
			panic_debug(444, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("last"),  _SLIT("array.last: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_pop(array* a) {
	...
	{
		if (a->len == 0) {
			panic_debug(471, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("pop"),  _SLIT("array.pop: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_delete_last(array* a) {
	...
	{
		if (a->len == 0) {
			panic_debug(490, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("delete_last"),  _SLIT("array.pop: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
array array_slice(array a, int start, int _end) {
	...
	{
		if (start > end) {
			panic_debug(509, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.slice: invalid slice index ("), /*100 &int*/0xfe07, {.d_i32 = start}}, {_SLIT(" > "), /*100 &int*/0xfe07, {.d_i32 = end}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (end > a.len) {
			panic_debug(512, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.slice: slice bounds out of range ("), /*100 &int*/0xfe07, {.d_i32 = end}}, {_SLIT(" >= "), /*100 &int*/0xfe07, {.d_i32 = a.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (start < 0) {
			panic_debug(515, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("array.slice: slice bounds out of range ("), /*100 &int*/0xfe07, {.d_i32 = start}}, {_SLIT(" < 0)"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_set(array* a, int i, voidptr val) {
	...
	{
		if (i < 0 || i >= a->len) {
			panic_debug(641, tos3("C:/dev/_tools/v/vlib/builtin/array.v"), tos3("builtin"), tos3("set"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.set: index out of range (i == "), /*100 &int*/0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), /*100 &int*/0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
VNORETURN void panic_option_not_set(string s) {
	panic_debug(90, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_option_not_set"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("option not set ("), /*115 &string*/0xfe10, {.d_s = s}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
	VUNREACHABLE();
	while(1);
}
...
VNORETURN void panic_result_not_set(string s) {
	panic_debug(97, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_result_not_set"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("result not set ("), /*115 &string*/0xfe10, {.d_s = s}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
	VUNREACHABLE();
	while(1);
}
...
VNORETURN void panic_error_number(string basestr, int errnum) {
	panic_debug(158, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_error_number"),  string__plus(basestr, c_error_number_str(errnum)));
	VUNREACHABLE();
	while(1);
}
...
u8* _v_malloc(isize n) {
	if (n <= 0) {
		panic_debug(320, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(" <= 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	u8* res = ((u8*)(0));
	...
	#endif
	if (res == 0) {
		panic_debug(345, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return res;
}
...
u8* malloc_noscan(isize n) {
	if (n <= 0) {
		panic_debug(363, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_noscan"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_noscan("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(" <= 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	u8* res = ((u8*)(0));
	#if defined(_VPREALLOC)
	...
	#endif
	if (res == 0) {
		panic_debug(392, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_noscan"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_noscan("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return res;
}
...
u8* malloc_uncollectable(isize n) {
	if (n <= 0) {
		panic_debug(422, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_uncollectable"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_uncollectable("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(" <= 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	u8* res = ((u8*)(0));
	#if defined(_VPREALLOC)
	...
	#endif
	if (res == 0) {
		panic_debug(445, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_uncollectable"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_uncollectable("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return res;
}
...
u8* v_realloc(u8* b, isize n) {
	...
	#endif
	if (new_ptr == 0) {
		panic_debug(477, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("v_realloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("realloc("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return new_ptr;
}
...
u8* realloc_data(u8* old_data, int old_size, int new_size) {
	...
	#endif
	if (nptr == 0) {
		panic_debug(523, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("realloc_data"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("realloc_data("), /*117 &u8*/0xfe11, {.d_p = (void*)(old_data)}}, {_SLIT(", "), /*100 &int*/0xfe07, {.d_i32 = old_size}}, {_SLIT(", "), /*100 &int*/0xfe07, {.d_i32 = new_size}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return nptr;
}
...
u8* vcalloc(isize n) {
	if (n < 0) {
		panic_debug(537, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("vcalloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("calloc("), /*100 &isize*/0xfe09, {.d_i64 = n}}, {_SLIT(" < 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (n == 0) {
		return ((u8*)(0));
	}
...
inline int v_fixed_index(int i, int len) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (i < 0 || i >= len) {
			...
			panic_debug(651, tos3("C:/dev/_tools/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("v_fixed_index"),  s);
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr __as_cast(voidptr obj, int obj_type, int expected_type) {
	if (obj_type != expected_type) {
		...
		panic_debug(39, tos3("C:/dev/_tools/v/vlib/builtin/builtin.v"), tos3("builtin"), tos3("__as_cast"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("as cast: cannot cast `"), /*115 &string*/0xfe10, {.d_s = obj_name}}, {_SLIT("` to `"), /*115 &string*/0xfe10, {.d_s = expected_name}}, {_SLIT("`"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return obj;
}
...
VNORETURN void panic_lasterr(string base) {
	panic_debug(302, tos3("C:/dev/_tools/v/vlib/builtin/builtin_windows.c.v"), tos3("builtin"), tos3("panic_lasterr"),  string__plus(base, winapi_lasterr_str()));
	VUNREACHABLE();
	while(1);
}
...
string u8_repeat(u8 b, int count) {
	if (count < 0) {
		panic_debug(573, tos3("C:/dev/_tools/v/vlib/builtin/int.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("byte.repeat: count is negative: "), /*100 &int*/0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
inline void map_ensure_extra_metas(map* m, u32 probe_count) {
	if ((probe_count << 1U) == m->extra_metas) {
		...
		if (probe_count == 252U) {
			panic_debug(366, tos3("C:/dev/_tools/v/vlib/builtin/map.v"), tos3("builtin"), tos3("ensure_extra_metas"),  _SLIT("Probe overflow"));
			VUNREACHABLE();
		}
	}
}
...
string rune_repeat(rune c, int count) {
	if (count < 0) {
		panic_debug(46, tos3("C:/dev/_tools/v/vlib/builtin/rune.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("rune.repeat: count is negative: "), /*100 &int*/0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
string tos(u8* s, int len) {
	if (s == 0) {
		panic_debug(105, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos"),  _SLIT("tos(): nil string"));
		VUNREACHABLE();
	}
...
string tos2(u8* s) {
	if (s == 0) {
		panic_debug(122, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos2"),  _SLIT("tos2: nil string"));
		VUNREACHABLE();
	}
...
string tos3(char* s) {
	if (s == 0) {
		panic_debug(139, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos3"),  _SLIT("tos3: nil string"));
		VUNREACHABLE();
	}
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_7566286269888172044_RepIndex_by_idx);
	u8* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
string string_replace_char(string s, u8 rep, u8 with, int repeat) {
	...
	{
		if (repeat <= 0) {
			panic_debug(504, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("replace_char"),  _SLIT("string.replace_char(): tab length too short"));
			VUNREACHABLE();
		}
	}
	#endif
...
bool string__eq(string s, string a) {
	if (s.str == 0) {
		panic_debug(655, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("=="),  _SLIT("string.eq(): nil string"));
		VUNREACHABLE();
	}
	if (s.len != a.len) {
		return false;
...
string string_substr(string s, int start, int end) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (start > end || start > s.len || end > s.len || start < 0 || end < 0) {
			panic_debug(876, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("substr"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("substr("), /*100 &int*/0xfe07, {.d_i32 = start}}, {_SLIT(", "), /*100 &int*/0xfe07, {.d_i32 = end}}, {_SLIT(") out of bounds (len="), /*100 &int*/0xfe07, {.d_i32 = s.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
byte string_at(string s, int idx) {
	...
	{
		if (idx < 0 || idx >= s.len) {
			panic_debug(1585, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("at"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("string index out of range: "), /*100 &int*/0xfe07, {.d_i32 = idx}}, {_SLIT(" / "), /*100 &int*/0xfe07, {.d_i32 = s.len}}, {_SLIT0, 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
string string_repeat(string s, int count) {
	if (count < 0) {
		panic_debug(1882, tos3("C:/dev/_tools/v/vlib/builtin/string.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("string.repeat: count is negative: "), /*100 &int*/0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
void main__main(void) {
	if (RoInitialize(main__RoInitType__singlethreaded) != 0U) {
		panic_debug(50, tos3("./main.v"), tos3("main"), tos3("main"),  _SLIT("Out of memory or something, idk"));
		VUNREACHABLE();
	}
	main__MetadataDispenser dispenser = main__get_metadata_dispenser();
	print(_SLIT("YYAAAAAA"));
}

main__MetadataDispenser main__get_metadata_dispenser(void) {
	main__Guid clsid_metadata_dispenser = ((main__Guid){.data1 = ((u32)(0xe5cb7a31U)),.data2 = ((u16)(0x7512U)),.data3 = ((u16)(0x11d2U)),.data4 = {((u8)(0x89)), ((u8)(0xce)), ((u8)(0x0)), ((u8)(0x80)), ((u8)(0xc7)), ((u8)(0x92)), ((u8)(0xe5)), ((u8)(0xd8))},});
	main__Guid iid_metadata_dispenser = ((main__Guid){.data1 = ((u32)(0x809c652eU)),.data2 = ((u16)(0x7396U)),.data3 = ((u16)(0x11d2U)),.data4 = {((u8)(0x97)), ((u8)(0x71)), ((u8)(0x00)), ((u8)(0xa0)), ((u8)(0xc9)), ((u8)(0xb4)), ((u8)(0xd5)), ((u8)(0x0c))},});
	voidptr ppv = ((void*)0);
	u32 hresult = MetaDataGetDispenser(&clsid_metadata_dispenser, &iid_metadata_dispenser, &ppv);
	if (hresult != 0U) {
		println(u32_str(hresult));
	}
	main__MetadataDispenser _t1 = ((main__MetadataDispenser){.clsid = clsid_metadata_dispenser,.iid = iid_metadata_dispenser,.ppv = ppv,});
	return _t1;
}
